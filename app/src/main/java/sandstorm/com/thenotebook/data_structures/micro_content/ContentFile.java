...
public class ContentFile extends AbstractContent
{
    File cache;

    public ContentFile(String data, File internalCacheDirectory)
    {
        try{
            Gson g = new Gson();
    ...
    public ContentFile(byte[] data, File internalCacheDirectory)
    {
        try{
            cache = new File(internalCacheDirectory.toString()+"//NewEditNoteCache");
    ...
    public String getType() {
        return AbstractContent.TYPE_FILE;
    }
