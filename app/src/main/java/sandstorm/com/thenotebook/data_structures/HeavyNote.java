...
public class HeavyNote extends AbstractNoteNotebook
{
    ...
    public HeavyNote(long id, long notebookId, long versionCode, int status)
    {
        this.id = id;
    ...
    public HeavyNote(long id, long notebookId, long versionCode, int status, int isSynced)
    {
        this.id = id;
        this.notebookId = notebookId;
        this.versionCode = versionCode;
    ...
    public HeavyNote(long id, long notebookId, long versionCode, int status, NoteContent content)
    {
        this.id = id;
        this.notebookId = notebookId;
        this.versionCode = versionCode;
    ...
    public HeavyNote(long id, long notebookId, long versionCode, int status, NoteContent content, int isSynced)
    {
        this.id = id;
        this.notebookId = notebookId;
        this.versionCode = versionCode;
